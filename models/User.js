...
User.prototype.validate = function() {
    return new Promise(async (resolve, reject) => {
        ...
        if (this.data.username != "" && !validator.isAlphanumeric) {this.errors.push("Usernmae can only contain letters and numbers.")}
        ...
        if (validator.isEmail(this.data.email)) {
            ...
            if (emailExists) {this.errors.push("A user with this email is already registered.")}
        }
        resolve()
    })
}
...
User.prototype.register = function() {
    return new Promise(async (resolve, reject) => {
        ...
        // only if  no validation errors save to a db
